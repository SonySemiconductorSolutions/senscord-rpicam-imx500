...
class Preview {
 public:
  ...
  virtual ~Preview() {}
  // This is where the application sets the callback it gets whenever the
  // viewfinder is no longer displaying the buffer and it can be safely
  // recycled.
  ...
  virtual void Show(int fd, libcamera::Span<uint8_t> span,
                    StreamInfo const &info) = 0;
